...
if &background == "dark"
  SynColor Comment	term=bold cterm=NONE ctermfg=244 ctermbg=NONE gui=NONE guifg=#80a0ff guibg=NONE
  ...
  SynColor Comment	term=bold cterm=NONE ctermfg=244 ctermbg=NONE gui=NONE guifg=Blue guibg=NONE
